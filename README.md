...
## 1. Opis
Celem projektu jest stworzenie inteligentnego systemu alarmowego z wielostrefową detekcją ruchu oraz wbudowanym interfejsem użytkownika. System umożliwia monitorowanie do ośmiu stref (w tym pięciu fizycznych czujników PIR) oraz zarządzanie stanem alarmu z poziomu ekranu LCD za pomocą menu nawigacyjnego. W celu optymalizacji użycia pinów mikrokontrolera zastosowano magistralę I2C do obsługi czujników oraz dodatkowych diod sygnalizacyjnych.

## Schemat podłączenia układu
![Schemat układu](ZrzutEkranu.png)

## 2. Sprzęt
* Płytka mikrokontrolera Arduino Uno R3
* Wyświetlacz LCD 16x2
* 5x Czujnik ruchu PIR (HC-SR501 / Parallax)
* 2x 8-portowy moduł rozszerzający I2C (ekspander PCF8574)
* Dekoder 7-segmentowy CD4511
* Wyświetlacz 7-segmentowy ze wspólną katodą
* Sygnalizator dźwiękowy (Piezo)
* Diody LED: Niebieska, Pomarańczowa, Czerwona oraz 4x Zielona
* 3x Przycisk monostabilny (do obsługi menu)
* Zestaw rezystorów: 220 Ω, 1 kΩ, 100 Ω, 50 Ω

Większość logiki oraz interfejs zasilana jest bezpośrednio z układu Arduino. Ze względu na dużą ilość komponentów wejścia/wyjścia, komunikacja z czujnikami PIR i częścią diod odbywa się za pośrednictwem dwóch układów PCF8574.

## 3. Kod i Podłączenie

**Tabela wyprowadzeń (Pinout):**

| Arduino Pin | Urządzenie / Komponent |
| :--- | :--- |
| **A0** | Przycisk UP |
| **A1** | Przycisk OK |
| **A2** | Przycisk DOWN |
| **A3** | Sygnalizator dźwiękowy (Buzzer) |
| **SDA / SCL** | Moduły PCF8574 (Adresy: 0x20 - LED, 0x21 - PIR) |
| **2, 3, 4, 5, 6, 7** | Wyświetlacz LCD (Piny: DB7, DB6, DB5, DB4, E, RS) |
